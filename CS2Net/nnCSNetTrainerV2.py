...
from generic_CSNet import Generic_CSNet
...
class nnCSNetTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_CSNet(self.num_input_channels, self.base_num_features, self.num_classes,
