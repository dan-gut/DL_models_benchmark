...
class Generic_CSNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_CSNet, self).__init__()
        ...
        self.affinity_attention = AffinityAttention(input_features)
