...
from nnCPFNetTrainerV2 import nnCPFNetTrainerV2
...
def main():
    ...
    output_folder_name = workdir + 'nnUNet_trained_models/nnUNet/2d/Task001_Hip/MEM_nnCPFNetTrainerV2__nnUNetPlansv2.1'
    dataset_directory = workdir + 'nnUNet_preprocessed/Task001_Hip'
    batch_dice = True 
    stage = 0
    trainer_class = nnCPFNetTrainerV2
