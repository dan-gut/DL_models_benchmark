...
from generic_CPFNet import CPFNet
...
class nnCPFNetTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            print(f'making dir at {self.output_folder}')
            ...
            num_pool = 5
            self.net_num_pool_op_kernel_sizes = [(2, 2)] * num_pool
    ...
    def initialize_network(self):
        ...
        self.network = CPFNet(self.num_input_channels, self.base_num_features, self.num_classes,
