...
from generic_modular_residual_UNet import ResidualUNet

class ResUNetTrainerV2(nnUNetTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        print('This is my super trainer class')
    ...
    def initialize_network(self):
        ...
        self.network = ResidualUNet(self.num_input_channels, self.base_num_features, self.num_classes,
