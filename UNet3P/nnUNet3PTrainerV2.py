...
from generic_UNet3P import Generic_UNet3P
...
class nnUNet3PTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet3P(self.num_input_channels, self.base_num_features, self.num_classes,
